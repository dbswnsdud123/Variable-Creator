...
export function activate(context: vscode.ExtensionContext) {
	...
	let translateInsert = vscode.commands.registerCommand('variable-creator.translateInsert', async () => {
	...
	let translate = vscode.commands.registerCommand('variable-creator.translate', async () => {
		docService.setCurrentEditor();
